...
export const environment = isBrowser ? "browser" : isReactNative ? "react-native" : "node";
...
export const MAX_CONCURRENT_SHARES = 8;
...
export const FILE_ENCRYPTION_VERSION = process?.env?.FILE_ENCRYPTION_VERSION
    ...
    : 2;
export const PUBLIC_LINK_VERSION = process?.env?.PUBLIC_LINK_VERSION
    ? parseInt(process.env.PUBLIC_LINK_VERSION)
    : 2;
export const REGISTER_AUTH_VERSION = process?.env?.REGISTER_AUTH_VERSION
    ? parseInt(process.env.REGISTER_AUTH_VERSION)
    : 2;
