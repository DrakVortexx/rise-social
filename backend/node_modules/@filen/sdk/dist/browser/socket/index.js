...
export class Socket extends EventEmitter {
    ...
    connected = false;
    authenticated = false;
    reconnectDelay = SOCKET_DEFAULTS.reconnectDelay;
    shouldReconnect = true;
    isConnecting = false;
    currentPingInterval = SOCKET_DEFAULTS.defaultPingInterval;
    /**
     ...
     */
    _handleSocketIOMessage(payload) {
    ...
    _handleSocketEvent(event, data) {
        ...
        if (eventType) {
            const socketEvent = eventType === "trashEmpty" || eventType === "passwordChanged"
                ? {
                    type: eventType
                }
                : {
