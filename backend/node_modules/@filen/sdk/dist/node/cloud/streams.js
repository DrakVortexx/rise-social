...
class ChunkedUploadWriter extends stream_1.Writable {
     ...
     */
    constructor({ options = undefined, uuid, key, name, uploadKey, parent, sdk, onProgress, onProgressId, lastModified, creation, onUploadDone }) {
        super(options);
    ...
    async finalizeUpload() {
        ...
        (_a = this.onUploadDone) === null || _a === void 0 ? void 0 : _a.call(this, fsItem);
