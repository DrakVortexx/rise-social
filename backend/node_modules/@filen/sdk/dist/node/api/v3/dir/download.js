...
class DirDownload {
    ...
    async fetch({ uuid, type = "normal", linkUUID, linkHasPassword, linkPassword, linkSalt, skipCache }) {
        ...
        const data = type === "shared" || type === "normal"
            ? Object.assign({ uuid }, (skipCache
                ? {
                    skipCache
                }
                : {})) : Object.assign({ uuid: linkUUID, parent: uuid, password: linkHasPassword && linkSalt && linkPassword
                ? linkSalt.length === 512
                    ? (await (0, utils_1.argon2id)(Buffer.from(linkPassword, "utf-8"), Buffer.from(linkSalt, "hex"), {
                        t: 3,
                        m: 65536,
                        p: 4,
                        version: 0x13,
