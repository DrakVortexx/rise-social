...
exports.APIClient = exports.APIClientDefaults = exports.keepAliveAgent = void 0;
...
exports.keepAliveAgent = new agentkeepalive_1.HttpsAgent();
...
class APIClient {
    constructor(sdk) {
        this.requestSemaphore = new semaphore_1.default(32);
        this.sdk = sdk;
    }
    /**
     ...
     */
    buildHeaders(params) {
        return Object.assign({ Authorization: "Bearer " + (params && params.apiKey ? params.apiKey : this.sdk.config.apiKey ? this.sdk.config.apiKey : "anonymous"), Accept: "application/json, text/plain, */*" }, (constants_1.environment === "node"
            ? {
        ...
        if (constants_1.environment === "node") {
            return new Promise((resolve, reject) => {
                ...
                const request = https_1.default.request({
                    ...
                    port: 443,
                    timeout,
                    agent: exports.keepAliveAgent,
                    headers: Object.assign(Object.assign({}, headers), (postDataIsBuffer
                        ? {}
                        : {
    ...
    async downloadChunkToLocal({ uuid, bucket, region, chunk, to, timeout, abortSignal, maxRetries, retryTimeout, onProgress, onProgressId }) {
        ...
        await new Promise((resolve, reject) => {
            (0, stream_1.pipeline)(response, fs_extra_1.default.createWriteStream(to), err => {
                if (err) {
                    reject(err);
                    return;
                }
    ...
    async uploadChunkBuffer({ uuid, index, parent, uploadKey, buffer, abortSignal, maxRetries, timeout, retryTimeout, onProgress, onProgressId }) {
        ...
        const parsedURLParams = (0, utils_1.parseURLParams)({
            url: fullURL
        });
