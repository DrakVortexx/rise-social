...
class Decrypt {
    ...
    async metadataPrivate({ metadata, privateKey }) {
        ...
        if (constants_1.environment === "node") {
            ...
            const forgePrivatKey = node_forge_1.default.pki.privateKeyFromPem(pemKey);
            const encryptedBytes = node_forge_1.default.util.decode64(metadata);
    ...
    async dataStream({ inputFile, key, version, outputFile }) {
        ...
        try {
            if (version === 1 || version === 1.5) {
                ...
                if (needsConvert && !isNormalCBC) {
                    ...
                    input = await (0, base64_1.streamDecodeBase64)({
                        inputFile: input,
        ...
        await new Promise((resolve, reject) => {
            (0, stream_1.pipeline)(readStream, decipher, writeStream, err => {
                if (err) {
                    reject(err);
                    return;
                }
