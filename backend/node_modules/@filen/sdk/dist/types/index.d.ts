...
export declare class FilenSDK {
    ...
    register({ email, password, refId, affId }: {
        email: string;
        password: string;
        refId?: string;
        affId?: string;
    ...
    readonly utils: {
        crypto: {
            ...
            argon2id: typeof import("./crypto/utils").argon2id;
            hashPublicLinkPassword: typeof import("./crypto/utils").hashPublicLinkPassword;
        };
        streams: {
