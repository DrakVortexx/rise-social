...
import { type FSItem, type ProgressCallback, type FilenSDK } from "..";
/**
 * ChunkedUploadWriter
...
export declare class ChunkedUploadWriter extends Writable {
     ...
     */
    constructor({ options, uuid, key, name, uploadKey, parent, sdk, onProgress, onProgressId, lastModified, creation, onUploadDone }: {
        options?: ConstructorParameters<typeof Writable>[0];
        sdk: FilenSDK;
        uuid: string;
        key: string;
