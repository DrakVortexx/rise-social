...
export declare function argon2id(password: Buffer, salt: Buffer, options: {
    t: number;
    m: number;
    p: number;
    version: number;
...
export declare function hashPublicLinkPassword({ password }: {
    password?: string;
}): Promise<{
    salt: string;
    hash: string;
...
export declare const utils: {
    ...
    hashPublicLinkPassword: typeof hashPublicLinkPassword;
};
